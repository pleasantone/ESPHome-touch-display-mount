...
**Not proposing anything further upstream** (user's decision, 2026-09-24). Kept locally only: the swatch colour fix + enlarged swatches (#31), `slider-live-colour`, the flex grid, 8 tiles, availability entities and contrast tuning.
